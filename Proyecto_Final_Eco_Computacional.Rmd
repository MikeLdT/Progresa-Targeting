...
```{r }
ruta_archivos<-"/Users/arleenholden/Documents/GitHub/Progresa-Targeting/"
...
base_prospera<-base%>%
  mutate(Prospera=ifelse(otorg_b==1|inst_5==5|servmed_4==4|inst_1==12|inst_2==12|inst==12|clave.y=="P042",1,2))%>%
